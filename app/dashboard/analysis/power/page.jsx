...
export default function PowerPage() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      const d = { ...json.analysis.power, optimizations: json.optimizations.filter(o => o.group === 'Power') };
      setData(d);
  ...
  const { p1Events, p2Events, p3Events, avgPower, maxPower, totalEnergy, optimizations } = data;
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', width: '100%' }}>
      ...
      {optimizations.length === 0 && (
        <div className="dash-empty">No power anomalies detected. Consumption looks normal.</div>
      )}
